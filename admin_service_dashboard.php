...
td, a{
    color:black;
        ...
        body {  x
            font-family: 'Roboto';
            /* background-image: url('library_Project/images/mail3.jpeg'); */
...
elseif($msg=="fail"){
    ...
    ?>
         ...
         <div class="container">
        <div class="innerdiv">
           <div class="row"><img class="imglogo" src="images/mail2.jpg"/></div>
           
           <br>
           <br>
            <div class="leftinnerdiv">
                <!-- <Button class="greenbtn"> ADMIN</Button> -->
                <Button class="greenbtn" onclick="openpart('addbook')" ><img class="icons" src="images/icon/email-13765.png" width="30px" height="30px"/>  ADD MAIL</Button>
                <Button class="greenbtn" onclick="openpart('bookreport')" > <img class="icons" src="images/icon/email-13776.png" width="30px" height="30px"/> MAIL REPORT</Button>
            
                <Button class="greenbtn" onclick="openpart('addperson')"> <img class="icons" src="images/icon/add-user.png" width="30px" height="30px"/> ADD EMPLOYEE</Button>
                <Button class="greenbtn" onclick="openpart('studentrecord')"> <img class="icons" src="images/icon/monitoring.png" width="30px" height="30px"/>EMPLOYEE REPORT</Button>
                <Button class="greenbtn"  onclick="openpart('issuebook')"> <img class="icons" src="images/icon/test.png" width="30px" height="30px"/> ISSUE MAIL</Button>
            ...
            <Button class="greenbtn" >ADD NEW MAIL</Button>
            <br>
            <form action="addbookserver_page.php" method="post" enctype="multipart/form-data">
            <label>Mail ID:</label><input type="text" name="mailid"/>
            </br>
            <label>Sender Name:</label><input  type="text" name="sendername"/></br>
            <label>Receipent:</label><input type="text" name="receipent"/></br>
            <label>Date:</label><input type="Number" name="date1"/></br>
            <label>Mailtype:</label><input type="text" name="mailtype"/></br>   
            <label>Status:</label><input  type="number" name="status1"/></br>
            <label>Unique Id:</label><input type="number" name="uniqueid"/></br>
            ...
            <label>Employee Id:</label><input type="text" name="addid"/>
            </br>
            <label>Employee Name:</label><input type="text" name="addname"/>
            </br>
            <label>Contact No:</label><input type="number" name="addnumber"/>
            </br>
            <label>Job Name:</label><input  type="text" name="addjobname"/></br>
            <label>Salary:</label><input  type="number" name="addsalary"/></br>
            ...
            <Button class="greenbtn" >EMPLOYEE RECORD</Button>
            ...
            <Button class="greenbtn" >ISSUE MAIL RECORD</Button>
...
issue book -->
            ...
            <Button class="greenbtn" >ISSUE MAIL</Button>
...
?>
            ...
            <Button class="greenbtn" >MAIL RECORD</Button>
            <?php
            $u=new data;
            $u->setconnection();
            $u->getbook();
