...
class mail extends db {
    ...
    function addmail($mailid, $sendername, $receipent, $date1, $mailtype, $status1, $uniqueid) {
       ...
       $q="INSERT INTO mail (mailid,sendername,receipent, date1, mailtype, status1,uniqueid)VALUES('$mailid', '$sendername', '$receipent', '$date1', '$mailtype', '$status1','$uniqueid')";
